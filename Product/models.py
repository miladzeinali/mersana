...
class Product(models.Model):
    ...
    variety1 = models.CharField(max_length=150 ,null=True, blank=True,default=50)
    variety2 = models.CharField(max_length=150 ,null=True, blank=True,default=50)
    variety3 = models.CharField(max_length=150 ,null=True, blank=True,default=50)
    variety4 = models.CharField(max_length=150 ,null=True, blank=True,default=50)
    variety5 = models.CharField(max_length=150 ,null=True, blank=True,default=50)
    variety1price = models.PositiveSmallIntegerField(default=0)
    variety2price = models.PositiveSmallIntegerField(default=0)
    variety3price = models.PositiveSmallIntegerField(default=0)
    variety4price = models.PositiveSmallIntegerField(default=0)
    variety5price = models.PositiveSmallIntegerField(default=0)
